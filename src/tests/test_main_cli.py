...
class TestGenerateMediaCommand:
    ...
    def test_generate_media_success(self, mock_parse_scenes, mock_generate_image, 
        ...
        # Setup mocks
        mock_parse_scenes.return_value = [scene.model_dump() for scene in mock_scenes]
    ...
    def test_generate_media_with_verbose(self, mock_parse_scenes, mock_generate_image,
        ...
        result = runner.invoke(app, ["generate-media", temp_story_file, "--verbose"])
    ...
    def test_generate_media_max_scenes(self, mock_parse_scenes, mock_generate_image,
        ...
        result = runner.invoke(app, ["generate-media", temp_story_file, "--max-scenes", "2"])
    ...
    def test_generate_media_skip_existing(self, mock_parse_scenes, mock_generate_image,
        ...
        mock_parse_scenes.return_value = [scene.model_dump() for scene in mock_scenes]
        mock_check_assets.return_value = {1: True, 2: False, 3: False}  # Scene 1 exists
        mock_generate_image.return_value = "/path/to/scene.png"
        
        result = runner.invoke(app, ["generate-media", temp_story_file, "--skip-existing"])
    ...
    @patch('src.main.parse_scenes')
    def test_generate_media_no_scenes_parsed(self, mock_parse_scenes, runner, temp_story_file):
    ...
    def test_generate_media_image_generation_failure(self, mock_parse_scenes, mock_generate_image,
        ...
        mock_parse_scenes.return_value = [scene.model_dump() for scene in mock_scenes[:2]]
        mock_generate_image.side_effect = ["/path/to/scene_1.png", None]  # Second fails
...
class TestGenerateVideosCommand:
    ...
    def test_generate_videos_dry_run(self, mock_parse_scenes, mock_video_generator,
        ...
        result = runner.invoke(app, ["generate-videos", temp_story_file, "--dry-run"])
    ...
    def test_generate_videos_with_budget_warning(self, mock_parse_scenes, mock_video_generator,
        ...
        result = runner.invoke(app, ["generate-videos", temp_story_file], input="n\n")
    ...
    def test_generate_videos_with_images(self, mock_parse_scenes, mock_video_generator,
        ...
        mock_parse_scenes.return_value = [scene.model_dump() for scene in mock_scenes]
        mock_check_assets.return_value = {1: True, 2: True, 3: False}  # 2 images exist
        mock_generator_instance = Mock()
        ...
        result = runner.invoke(app, ["generate-videos", temp_story_file, "--dry-run", "--use-images"])
...
class TestGenerateAllCommand:
    ...
    def test_generate_all_success(self, mock_parse_scenes, mock_generate_image,
        ...
        result = runner.invoke(app, ["generate-all", temp_story_file, "--dry-run-videos"], input="y\n")
...
class TestOtherCommands:
    ...
    @patch('src.main.VideoGenerator')
    @patch('src.main.parse_scenes')
    def test_test_command(self, mock_parse_scenes, mock_video_generator, runner, mock_scenes):
...
class TestErrorHandling:
    ...
    def test_unicode_decode_error(self, mock_load_story, runner, temp_story_file):
        """Test handling of unicode decode errors."""
        mock_load_story.side_effect = UnicodeDecodeError("utf-8", b"", 0, 1, "invalid")
    ...
    @patch('src.main.parse_scenes')
    def test_unexpected_error_handling(self, mock_parse_scenes, runner, temp_story_file):
...
class TestOutputFormatting:
    ...
    def test_summary_table_creation(self, mock_parse_scenes, mock_generate_image,
        ...
        mock_parse_scenes.return_value = [scene.model_dump() for scene in mock_scenes]
        mock_generate_image.side_effect = ["/path/to/scene_1.png", None, "/path/to/scene_3.png"]
...
class TestAssetManagement:
    ...
    @patch('src.main.check_existing_assets')
    @patch('src.main.parse_scenes')
    def test_overwrite_mode(self, mock_parse_scenes, mock_check_assets, runner, mock_scenes, temp_story_file):
        """Test overwrite mode ignores existing assets."""
        mock_parse_scenes.return_value = [scene.model_dump() for scene in mock_scenes]
        mock_check_assets.return_value = {1: True, 2: True, 3: True}  # All exist
        
        with patch('src.main.generate_scene_image') as mock_generate_image:
            mock_generate_image.return_value = "/path/to/scene.png"
            
            result = runner.invoke(app, ["generate-media", temp_story_file, "--overwrite"])
...
class TestCLIIntegration:
    ...
    def test_complete_workflow_dry_run(self, mock_parse_scenes, mock_generate_image,
        ...
        result2 = runner.invoke(app, ["generate-videos", temp_story_file, "--dry-run"])
        assert result2.exit_code == 0
        
        # Test complete pipeline
        result3 = runner.invoke(app, ["generate-all", temp_story_file, "--dry-run-videos"])
